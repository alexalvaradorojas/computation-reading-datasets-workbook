...
# 🤖✨🐱 DH201: Introduction to Digital Humanities and Project Management | Instructor: Dr. Cindy Nguyen

# *An Intepretative Computational Approach to Reading Datasets - Notebook Workshop* | Guest Lecturer: Alejandro Alvarado Rojas, PhD Candidate
...
This notebook should enable you to:
 ...
 1.    Perforrm data manipulation, descriptive statistical analysis, and visualizations to understand the composition of a dataset (Meta-Kaggle)
 2.   Leverage these descriptive and statistical analysis and data visualizations to inform modes of humanistic data critique, such as Forensic Qualitative Analysis (FQA)


Whether or not a researcher compiles her own data set or uses preexisting data, she must understand the constructed and subjective nature of its categories, codes, and silences
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/alexalvaradorojas/computation-reading-datasets-workbook/blob/main/DH_2021_Notebook_Workshop.ipynb)
